...
5. Generate a single random number, from 0 to 100, then output all the odd numbers from 40 to the random number. If the number is less than 40, outpit all the odd numbers from 0 to 40.