...
12. Generate two random numbers from 0 to 100 and output the smallest number such that each shares a least common denominator. For example, 18 and 6 should return 6 and 9 and 4 should return "Cannot compute".