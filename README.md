...
33. Create an app that pulls in your Github repos using AJAX. PUSH it to Heroku. Document the PUSH process. [http://git-ajax.herokuapp.com/](http://git-ajax.herokuapp.com/)
